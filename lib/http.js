...
const { decode, encode, byteLength } = Deno.core
...
class Request {
  ...
  get method () {
    ...
    this.#method = decode(this.#u8.slice(0, this.#method_len))
    return this.#method
  }

  get url () {
    if (this.#url) return this.#url
    this.#url = decode(this.#u8.slice(this.#method_len + 1, this.#method_len + 1 + this.#url_len))
    return this.#url
  }
